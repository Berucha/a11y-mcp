...
```bash
# Copy the MCP server
cp ~/accessibility-test/a11y-mcp/mcp-server-simple.js .github/a11y-mcp/
...
cp ~/accessibility-test/a11y-mcp/github-actions/accessibility-mcp-workflow.yml .github/workflows/accessibility-check.yml
```
...
### Problem: "mcp-server-simple.js not found"

**Check:**
```bash
ls .github/a11y-mcp/mcp-server-simple.js
```

**Solution:** Copy the file again:
```bash
cp ~/accessibility-test/a11y-mcp/mcp-server-simple.js .github/a11y-mcp/
git add .github/a11y-mcp/mcp-server-simple.js
...
**Add more checks:**
Edit `.github/a11y-mcp/mcp-server-simple.js` and add detection for:
